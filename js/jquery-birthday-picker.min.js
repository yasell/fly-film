$(function(e) {
	...
	updateTheBirthDayValue = function(e, a, t, r, n) {
		...
		var l = t.attr("id").replace(/-/g, ""),
			o = e("<div class='birthdayPicker'></div>"),
		...
		$birthday = e("<input class='birthDay' name='" + l + "_birthDay' type='hidden'/>"), i.placeholder && (e("<option value='0'>Year</option>").appendTo(d), e("<option value='0'>Month</option>").appendTo(p), e("<option value='0'>Day</option>").appendTo(s)), "bigEndian" == i.dateFormat ? o.append(d).append(p).append(s) : "littleEndian" == i.dateFormat ? o.append(s).append(p).append(d) : o.append(p).append(s).append(d);
		var h = r - i.minAge,
			c = r - i.maxAge;
